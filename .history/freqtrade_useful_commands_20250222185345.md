...
Then, we are good to go to start downloading data for backtesting. To download data for the selected pairlists, for the timeframes `["5m", "15m", "1h", "4h", "1d"]`, run the following command:
