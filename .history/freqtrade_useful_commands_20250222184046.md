...
```json
'BTC/USDC', 
'ETH/USDC', 'XRP/USDC', 'SOL/USDC', 'FDUSD/USDC', 'DOGE/USDC', 'ADA/USDC', 'SUI/USDC', 'PEPE/USDC', 'EUR/USDC', 
'HBAR/USDC', 'LINK/USDC', 'LTC/USDC', 'AVAX/USDC', 'DOT/USDC', 'SHIB/USDC', 'ENA/USDC', 'WIF/USDC', 'RUNE/USDC',
'AAVE/USDC'
```
